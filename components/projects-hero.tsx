...
export function ProjectsHero() {
  return (
    <section className="min-h-[60vh] flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-background to-secondary/5 relative overflow-hidden perspective">
      ...
      />
      <motion.div
        className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-secondary/10 rounded-full blur-3xl"
        animate={{
          x: [0, -60, 0],
          y: [0, -50, 0],
          scale: [1, 1.2, 1],
        ...
        transition={{ duration: 13, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut", delay: 1 }}
      />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <motion.div initial="hidden" animate="visible" variants={slideUpVariants} className="space-y-6">
          ...
          >
            Our Top 10 <span className="text-accent">Projects</span>
          </motion.h1>
          ...
          >
            Showcase of successful projects that demonstrate our expertise and commitment to excellence.
          </motion.p>
        </motion.div>
      </div>
    </section>
